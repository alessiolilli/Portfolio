<template>
    <div class="flex flex-row  bg-side text-white">
        <div class="flex flex-col m-4 justify-center">
            <div class="flex flex-col h-auto w-16 ">
                <div class="flex">
                    <img src="../assets/piccola.jpg" class="rounded-full border-4 border-gray-600" alt="">
                </div>
                <!-- <div class="">
                    ...
                    <div class="flex flex-coll border-white border-2 rounded-full p-2 bg-gray-700 cursor-pointer" @click="goTo('https://www.linkedin.com/in/alessio-lilli-628160202/')">
        ...
        <div class="flex w-full justify-end ">
            <div class="flex flex-col justify-center cursor-pointer m-10">
                <a href="#home">

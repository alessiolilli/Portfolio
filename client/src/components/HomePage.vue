                ...
                <div class="flex flex-col bg-white pl-4">
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-x-5 gap-y-5">
                        <div class="flex">
                            ...
                            <div class="flex flex-col">Birthday:</div>
                            <div class="flex flex-col ml-2">2 November 1999</div>
                        </div>
                        <div class="flex">
                            <div class="flex flex-col justify-center">
                                <font-awesome-icon icon="fa-solid fa-angle-right" class="mr-3 prova"/>
                        ...
                        <div class="flex">
                            ...
                            <div class="flex flex-col">Phone:</div>
                            <div class="flex flex-col ml-2">+39 3246286156</div>
                        </div>
                        <div class="flex">
                            <div class="flex flex-col justify-center">
                                <font-awesome-icon icon="fa-solid fa-angle-right" class="mr-3 prova"/>
                            </div>
                            <div class="flex flex-col">City:</div>
                            <div class="flex flex-col ml-2">Padoua, Italy</div>
                        </div>
                        <div class="flex">
                            <div class="flex flex-col justify-center">
                                <font-awesome-icon icon="fa-solid fa-angle-right" class="mr-3 prova"/>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div class="resume-item">
                                            ...
                                            <h5>2020 - present</h5>
                                            <p @click="goToLink('https://itslogistica.it/tecnico-superiore-digital-transformation-specialist')" class="cursor-pointer text-blue-700"><em>ITS last, Verona VR</em></p>
                                        ...
                                        <div class="resume-item">
                                            ...
                                            <h5>2013 - 2019</h5>
                                            <p @click="goTLink('https://www.einaudigramsci.edu.it/pagine/articolazione-sia')" class="cursor-pointer text-blue-700"><em>ITSCT Einaudi Gramsci, Padua, PD</em></p>
                                ...
                                <div class="mb-3">
                                    <div>
                                        ...
                                        <div class="resume-item">
                                            ...
                                            <div class="cursor-pointer text-blue-700" @click="goToLink('https://kuama.it/')"><em>Kuama S.r.l., Vigonza, PD</em></div>
                                        ...
                                        <div class="resume-item">
                                            ...
                                            <div class="cursor-pointer text-blue-700" @click="goToLink('https://www.synclab.it/')"><em>Sync Lab S.r.l., Padua, PD</em></div>
                                            <ul class="list-disk ml-9">
